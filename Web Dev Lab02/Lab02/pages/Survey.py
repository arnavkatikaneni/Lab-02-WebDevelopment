...
with st.form("survey_form"):
    ...
    category_input = st.text_input("What is your favorite TV show right now?")
    value_input = st.text_input("How many hours a week do you watch it?")
    ...
    if submitted:
        if category_input == "" or value_input == "":
            st.warning("Please fill out both boxes.")
        else:
            outfile = open("data.csv", "a")
            outfile.write(category_input + "," + value_input + "\n")
            outfile.close()
